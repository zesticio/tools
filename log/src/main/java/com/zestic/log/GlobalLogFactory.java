...
public class GlobalLogFactory {
	 ...
	 * 自定义日志实现
	 * 
	 * @see com.zestic.log.dialect.slf4j.Slf4jLogFactory
	 * @see com.zestic.log.dialect.log4j.Log4jLogFactory
	 * @see com.zestic.log.dialect.log4j2.Log4j2LogFactory
	 * @see com.zestic.log.dialect.commons.ApacheCommonsLogFactory
	 * @see com.zestic.log.dialect.jdk.JdkLogFactory
	 * @see com.zestic.log.dialect.console.ConsoleLogFactory
	 * 
