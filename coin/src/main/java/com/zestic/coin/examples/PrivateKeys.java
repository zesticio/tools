 ...
 * .0</a><p>
 * <p>
 * in which a private key with some coins associated with it is published. The
 * goal is to import the private key, claim the coins and then send them to a
 * different address.
 */
public class PrivateKeys {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            BigInteger privKey = Base58.decodeToBigInteger("919872177944");
