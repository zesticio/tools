 ...
 */
package com.zestic.coin.examples;

import com.zestic.coin.core.*;
...
/*
 * PingService demonstrates basic usage of the library. It sits on the network
 * and when it receives coins, simply sends them right back to the previous
 * owner, determined rather arbitrarily by the address of the first input.
 */
