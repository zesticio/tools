package com.zestic.coin.bouncycastle.crypto.encodings;
...
public class ISO9796d1Encoding
     ...
     * (key_size_in_bits + 3)/16, which in our world comes to key_size_in_bytes
     * / 2.
     */
    ...
    /*
     * @exception InvalidCipherTextException if the decrypted block is not a
     * valid ISO 9796 bit string
     */
