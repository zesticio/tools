package com.zestic.coin.bouncycastle.asn1.teletrust;

import com.zestic.coin.bouncycastle.math.ec.ECCurve;
import com.zestic.coin.bouncycastle.asn1.DERObjectIdentifier;
import com.zestic.coin.bouncycastle.asn1.x9.X9ECParameters;
import com.zestic.coin.bouncycastle.asn1.x9.X9ECParametersHolder;
...
public class TeleTrusTNamedCurves {
    ...
    /*
     * return the object identifier signified by the passed in name. Null if
     * there is no object identifier associated with name.
     *
    ...
    /*
     * returns an enumeration containing the name strings for curves contained
     * in this structure.
     */
