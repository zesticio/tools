package com.zestic.coin.bouncycastle.asn1.misc;
...
public class NetscapeCertType
     ...
     * Basic constructor.
     *
     * @param usage - the bitwise OR of the Key Usage flags giving the allowed
     * uses for the key. e.g. (X509NetscapeCertType.sslCA |
