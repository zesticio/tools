...
import com.zestic.coin.bouncycastle.crypto.engines.AESFastEngine;
...
/*
 * A manager for ciphersuite. This class does manage all ciphersuites which are
 * used by MicroTLS.
 */
...
//    private static final int TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA = 0xC022;
    protected static void writeCipherSuites(OutputStream os) throws IOException {
        int[] suites = new int[]{
            ...
            TLS_RSA_WITH_3DES_EDE_CBC_SHA, //            TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA,
