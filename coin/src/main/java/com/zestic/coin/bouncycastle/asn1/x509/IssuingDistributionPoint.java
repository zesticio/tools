...
public class IssuingDistributionPoint
     ...
     *
     * @param distributionPoint May contain an URI as pointer to most current
     * CRL.
     * @param onlyContainsUserCerts Covers revocation information for end
     * certificates.
     * @param onlyContainsCACerts Covers revocation information for CA
     * certificates.
     *
     ...
     * @param onlyContainsAttributeCerts Covers revocation information for
