...
public class TargetInformation
    ...
    /*
     * Constructs a target information from a single targets element. According
     * to RFC 3281 only one targets element must be produced.
     *
     ...
     * multiple targets are given they must be merged in into one targets
     * element.
     *
     ...
     * {@link ASN1Sequence} the encoding is
     * kept.
     *
     * @return a DERObject
     */
