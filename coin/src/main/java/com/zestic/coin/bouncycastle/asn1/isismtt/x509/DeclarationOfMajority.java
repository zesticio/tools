package com.zestic.coin.bouncycastle.asn1.isismtt.x509;
 ...
 * <
 * pre>
 * DeclarationOfMajoritySyntax ::= CHOICE { notYoungerThan [0] IMPLICIT INTEGER,
 * fullAgeAtCountry [1] IMPLICIT SEQUENCE { fullAge BOOLEAN DEFAULT TRUE,
 * country PrintableString (SIZE(2)) } dateOfBirth [2] IMPLICIT GeneralizedTime
 * }
 * </pre>
 * <p/>
...
public class DeclarationOfMajority
     ...
     * <
     * pre>
     * DeclarationOfMajoritySyntax ::= CHOICE { notYoungerThan [0] IMPLICIT
     * INTEGER, fullAgeAtCountry [1] IMPLICIT SEQUENCE { fullAge BOOLEAN DEFAULT
     * TRUE, country PrintableString (SIZE(2)) } dateOfBirth [2] IMPLICIT
     * GeneralizedTime }
     * </pre>
     *
     * @return a DERObject
