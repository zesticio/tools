package com.zestic.coin.bouncycastle.crypto.signers;

import com.zestic.coin.bouncycastle.crypto.AsymmetricBlockCipher;
...
import com.zestic.coin.bouncycastle.crypto.SignerWithRecovery;
import com.zestic.coin.bouncycastle.crypto.digests.RIPEMD128Digest;
...
import com.zestic.coin.bouncycastle.crypto.params.ParametersWithSalt;
...
public class ISO9796d2PSSSigner
    ...
    /*
     * Generate a signer for the with either implicit or explicit trailers for
     * ISO9796-2, scheme 2 or 3.
     *
     ...
     * parameters are for generation they should be a ParametersWithRandom, a
     * ParametersWithSalt, or just an RSAKeyParameters object. If
     * RSAKeyParameters are passed in a SecureRandom will be created.
    ...
    /*
     * return true if the signature represents a ISO9796-2 signature for the
     * passed in message.
     */
