...
public class RoleSyntax
     ...
     * object.
     * @throws IllegalArgumentException if the object passed to the
     * factory is not an instance of <code>RoleSyntax</code> or
     ...
     * extracting the encoded elements from the <code>ASN1Sequence</code> object
     * supplied.
     *
     * @param seq an instance of <code>ASN1Sequence</code> that holds the
     * encoded elements used to build this <code>RoleSyntax</code>.
     */
    public RoleSyntax(
            ASN1Sequence seq) {
     ...
     *
     * @return an instance of <code>GeneralNames</code> holding the role
     * authority of this RoleSyntax.
     */
     ...
     *
     * @return an instance of <code>GeneralName</code> holding the role name of
     * this RoleSyntax.
     */
