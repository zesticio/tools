...
public class DERExternal
     ...
     *
     * @param directReference The direct reference or <code>null</code> if not
     * set.
     * @param indirectReference The indirect reference or <code>null</code> if
     * not set.
     * @param dataValueDescriptor The data value descriptor or <code>null</code>
     * if not set.
    ...
    void encode(DEROutputStream out)
        ...
        out.writeEncoded(CONSTRUCTED, EXTERNAL, baos.toByteArray());
    }
