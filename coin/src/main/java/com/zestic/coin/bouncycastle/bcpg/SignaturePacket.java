...
public class SignaturePacket
    ...
    /*
     * return the signature trailer that must be included with the data to
    ...
    /*
     * return the signature as a set of integers - note this is normalised to be
     * the ASN.1 encoding of what appears in the signature packet.
     */
