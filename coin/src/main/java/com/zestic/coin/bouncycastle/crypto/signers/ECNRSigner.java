...
import com.zestic.coin.bouncycastle.crypto.DSA;
...
import com.zestic.coin.bouncycastle.crypto.params.ECKeyParameters;
...
import com.zestic.coin.bouncycastle.math.ec.ECAlgorithms;
import com.zestic.coin.bouncycastle.math.ec.ECConstants;
import com.zestic.coin.bouncycastle.math.ec.ECPoint;
import com.zestic.coin.bouncycastle.crypto.generators.ECKeyPairGenerator;
...
public class ECNRSigner
     ...
     * initialised with. Generally, the order of the curve should be at least as
     * long as the hash of the message of interest, and with ECNR it *must* be
     * at least as long.
     *
     * @param digest the digest to be signed.
     * @exception DataLengthException if the digest is longer than the key
     * allows
     */
    ...
    /*
     * return true if the value r and s represent a signature for the message
     * passed in. Generally, the order of the curve should be at least as long
     * as the hash of the message of interest, and with ECNR, it *must* be at
     * least as long. But just in case the signer applied mod(n) to the longer
     * digest, this implementation will apply mod(n) during verification.
     *
