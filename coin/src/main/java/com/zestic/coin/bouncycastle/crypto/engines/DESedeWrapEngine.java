...
import com.zestic.coin.bouncycastle.crypto.Wrapper;
...
import com.zestic.coin.bouncycastle.crypto.params.ParametersWithIV;
...
import com.zestic.coin.bouncycastle.util.Arrays;
 ...
 * Note:
 * <ul>
 * <li>this is based on a draft, and as such is subject to change - don't use
 * this class for anything requiring long term storage.
...
public class DESedeWrapEngine
     ...
     * [CMS-Algorithms]. This is used to provide an integrity check value for
     * the key being wrapped. The algorithm is
     *
     * - Compute the 20 octet SHA-1 hash on the key being wrapped. - Use the
     * first 8 octets of this hash as the checksum value.
     *
     * @param key
