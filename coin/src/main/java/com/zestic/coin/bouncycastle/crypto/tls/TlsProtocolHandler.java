...
import com.zestic.coin.bouncycastle.asn1.x509.SubjectPublicKeyInfo;
import com.zestic.coin.bouncycastle.asn1.x509.X509Extension;
import com.zestic.coin.bouncycastle.crypto.digests.SHA1Digest;
import com.zestic.coin.bouncycastle.asn1.DERBitString;
import com.zestic.coin.bouncycastle.asn1.x509.KeyUsage;
import com.zestic.coin.bouncycastle.asn1.x509.X509CertificateStructure;
import com.zestic.coin.bouncycastle.asn1.x509.X509Extensions;
import com.zestic.coin.bouncycastle.crypto.AsymmetricCipherKeyPair;
import com.zestic.coin.bouncycastle.crypto.CryptoException;
import com.zestic.coin.bouncycastle.crypto.InvalidCipherTextException;
import com.zestic.coin.bouncycastle.crypto.Signer;
import com.zestic.coin.bouncycastle.crypto.agreement.DHBasicAgreement;
import com.zestic.coin.bouncycastle.crypto.agreement.srp.SRP6Client;
...
import com.zestic.coin.bouncycastle.crypto.generators.DHBasicKeyPairGenerator;
import com.zestic.coin.bouncycastle.crypto.io.SignerInputStream;
import com.zestic.coin.bouncycastle.crypto.params.AsymmetricKeyParameter;
import com.zestic.coin.bouncycastle.crypto.params.DHKeyGenerationParameters;
import com.zestic.coin.bouncycastle.crypto.params.DHParameters;
import com.zestic.coin.bouncycastle.crypto.params.DHPublicKeyParameters;
import com.zestic.coin.bouncycastle.crypto.params.DSAPublicKeyParameters;
import com.zestic.coin.bouncycastle.crypto.params.ParametersWithRandom;
import com.zestic.coin.bouncycastle.crypto.params.RSAKeyParameters;
import com.zestic.coin.bouncycastle.crypto.prng.ThreadedSeedGenerator;
import com.zestic.coin.bouncycastle.crypto.util.PublicKeyFactory;
import com.zestic.coin.bouncycastle.util.BigIntegers;
...
//        }
    ...
    /*
     * Read data from the network. The method will return immediately, if there
     * is still some data left in the buffer, or block until some application
