...
import com.zestic.coin.bouncycastle.crypto.params.RC5Parameters;
...
public class RC532Engine
    ...
    /*
     * Encrypt the given block starting at the given offset and place the result
    ...
    //////////////////////////////////////////////////////////////
    /*
     * Perform a left "spin" of the word. The rotation of the given word
     * <em>x</em> is rotated left by <em>y</em> bits. Only the <em>lg(32)</em>
     * low-order bits of <em>y</em>
     * are used to determine the rotation amount. Here it is assumed that the
     * wordsize used is a power of 2.
     * <p>
    ...
    /*
     * Perform a right "spin" of the word. The rotation of the given word
     * <em>x</em> is rotated left by <em>y</em> bits. Only the <em>lg(32)</em>
     * low-order bits of <em>y</em>
     * are used to determine the rotation amount. Here it is assumed that the
     * wordsize used is a power of 2.
