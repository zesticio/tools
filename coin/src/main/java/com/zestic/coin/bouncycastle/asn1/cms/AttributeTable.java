...
import com.zestic.coin.bouncycastle.asn1.DEREncodableVector;
...
public class AttributeTable {
    ...
    /*
     * Return all the attributes matching the OBJECT IDENTIFIER oid. The vector
     * will be empty if there are no attributes of the required type present.
     *
     * @param oid type of attribute required.
