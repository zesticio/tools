...
public class ArmoredInputStream
    ...
    /*
     * Create a stream for reading a PGP armoured message, parsing up to a
     * header and then reading the data that follows.
     *
     * @param in
     */
    ...
    /*
     * @return true if we are inside the clear text section of a PGP signed
     * message.
     */
