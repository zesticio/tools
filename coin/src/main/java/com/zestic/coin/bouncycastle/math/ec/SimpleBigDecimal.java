 ...
 * {@link BigInteger BigInteger} with a few digits on the right of the
 * decimal point. The number of (binary) digits on the right of the decimal
 ...
 */
class SimpleBigDecimal //extends Number   // not in J2ME - add compatibility class?
{
