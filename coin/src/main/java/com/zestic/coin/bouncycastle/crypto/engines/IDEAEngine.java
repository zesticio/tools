package com.zestic.coin.bouncycastle.crypto.engines;

import com.zestic.coin.bouncycastle.crypto.CipherParameters;
import com.zestic.coin.bouncycastle.crypto.BlockCipher;
 ...
 * (F.U.Mirza@sheffield.ac.uk). (baring 1 typo at the end of the mulinv
 * function!).
 * <p>
 * It can be found at ftp://ftp.funet.fi/pub/crypt/cryptography/symmetric/idea/
 * <p>
 * Note 1: This algorithm is patented in the USA, Japan, and Europe including at
 * least Austria, France, Germany, Italy, Netherlands, Spain, Sweden,
 * Switzerland and the United Kingdom. Non-commercial use is free, however any
 * commercial products are liable for royalties. Please see
 * <a href="http://www.mediacrypt.com">www.mediacrypt.com</a> for further
 * details. This announcement has been included at the request of the patent
 * holders.
 * <p>
...
public class IDEAEngine
    ...
    /*
     * return x = x * y where the multiplication is done modulo 65537 (0x10001)
     * (as defined in the IDEA specification) and a zero input is taken to be
     * 65536 (0x10000).
     *
     * @param x the x value
     * @param y the y value
     ...
     * also involves the multiplicative inverse and the additive inverse
     * functions.
     */
