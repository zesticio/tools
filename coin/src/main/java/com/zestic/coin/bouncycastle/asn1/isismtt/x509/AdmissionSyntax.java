 ...
 * <li>See http://www.teletrust.de/anwend.asp?Id=30200&Sprache=E_&HomePG=0 for
...
public class AdmissionSyntax
     ...
     * professionInfos SEQUENCE OF ProfessionInfo }
     * <p/>
     * NamingAuthority ::= SEQUENCE { namingAuthorityId OBJECT IDENTIFIER
     * OPTIONAL, namingAuthorityUrl IA5String OPTIONAL, namingAuthorityText
     * DirectoryString(SIZE(1..128)) OPTIONAL }
     * <p/>
     * ProfessionInfo ::= SEQUENCE { namingAuthority [0] EXPLICIT
     * NamingAuthority OPTIONAL, professionItems SEQUENCE OF DirectoryString
     * (SIZE(1..128)), professionOIDs SEQUENCE OF OBJECT IDENTIFIER OPTIONAL,
