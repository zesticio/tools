...
import com.zestic.coin.bouncycastle.asn1.x500.DirectoryString;
import com.zestic.coin.bouncycastle.asn1.x509.GeneralName;
import com.zestic.coin.bouncycastle.asn1.x509.IssuerSerial;
...
public class ProcurationSyntax
     ...
     * <
     * pre>
     * ProcurationSyntax ::= SEQUENCE { country [1] EXPLICIT
     * PrintableString(SIZE(2)) OPTIONAL, typeOfSubstitution [2] EXPLICIT
     * DirectoryString (SIZE(1..128)) OPTIONAL, signingFor [3] EXPLICIT
     * SigningFor }
     * <p/>
