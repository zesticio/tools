package com.zestic.coin.bouncycastle.math.ec;
...
class Tnaf {
     ...
     * must be computed differently, see e.g. "Guide to Elliptic Curve
     * Cryptography", Darrel Hankerson, Alfred Menezes, Scott Vanstone,
     ...
     * and <code>U<sub>k</sub></code> or <code>V<sub>k-1</sub></code> and
     * <code>V<sub>k</sub></code>.
     */
...
//            System.out.println("tw = " + tw);
     ...
     * @throws IllegalArgumentException if <code>curve</code> is not a Koblitz
     * curve (Anomalous Binary Curve, ABC).
     */
    ...
    /*
     * Partial modular reduction modulo <code>(&tau;<sup>m</sup> - 1)/(&tau; -
     * 1)</code>.
     *
     ...
     * modular reduction.
     * @return <code>&rho; := k partmod (&tau;<sup>m</sup> - 1)/(&tau; -
     * 1)</code>
     */
     ...
     * {@link ECPoint.F2m ECPoint.F2m}
     * by an element <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> using
     * the <code>&tau;</code>-adic NAF (TNAF) method, given the TNAF of
     * <code>&lambda;</code>.
     *
     * @param p The ECPoint.F2m to multiply.
