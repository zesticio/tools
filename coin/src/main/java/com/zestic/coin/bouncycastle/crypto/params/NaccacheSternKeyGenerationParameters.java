...
public class NaccacheSternKeyGenerationParameters extends KeyGenerationParameters {
     ...
     * @param certainty the probability that the generated primes are not really
     * prime as integer: 2^(-certainty) is then the probability
     ...
     * prime as integer: 2^(-certainty) is then the probability
     * @param cntSmallPrimes How many small key factors are desired
     * @param debug Turn debugging on or off (reveals secret information, use
     * with caution)
     */
