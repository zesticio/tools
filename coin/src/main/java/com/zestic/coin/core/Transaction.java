...
import static com.zestic.coin.core.Utils.*;
...
public class Transaction extends Message implements Serializable {
    ...
    /*
     * Adds the given block to the internal serializable set of blocks in which
     ...
     * have to do this step last.<p>
     * <p>
     * This method is similar to SignatureHash in script.cpp
     *
     * @param hashType This should always be set to SigHash.ALL currently. Other
     *                 types are unused.
    ...
    /*
     * Given a named input and the transaction output it connects to, runs the
     * script formed from the concatenation of the input and output scripts,
     * returning true if the link is valid. In this way, we prove that the
     * creator of this transaction is allowed to redeem the output of the
     * connectedTx and thus spend the money.<p>
     *
