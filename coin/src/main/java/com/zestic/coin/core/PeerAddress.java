...
import static com.zestic.coin.core.Utils.uint32ToByteStreamLE;
import static com.zestic.coin.core.Utils.uint64ToByteStreamLE;

/*
 * A PeerAddress holds an IP address and port number representing the network
 * location of a peer in the BitCoin P2P network. It exists primarily for
