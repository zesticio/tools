...
public class TransactionOutPoint extends Message implements Serializable {
    ...
    /*
     * Scans the list for the transaction this outpoint refers to, and sets up
     * the internal reference used by getConnectedOutput().
     *
     * @return true if connection took place, false if the referenced
     * transaction was not in the list.
     */
    ...
    /*
     * If this transaction was created using the explicit constructor rather
     * than deserialized, retrieves the connected output transaction. Asserts if
     * there is no connected transaction.
     */
