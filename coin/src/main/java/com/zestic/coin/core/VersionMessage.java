...
public class VersionMessage extends Message {
    ...
    /*
     * A services flag that denotes whether the peer has a copy of the block
     * chain or not.
     */
    ...
    /*
     * Flags defining what is supported. Right now {@link #NODE_NETWORK} is the
     * only flag defined.
     */
    ...
    /*
     * An additional string that today the official client sets to the empty
     * string. We treat it as something like an HTTP User-Agent header.
     */
