...
public class TransactionOutput extends Message implements Serializable {
    ...
    /*
     * Returns the value of this output in nanocoins. This is the amount of
     * currency that the destination address receives.
     */
    ...
    /*
     * Returns true if this output is to an address we have the keys for in the
     * wallet.
     */
