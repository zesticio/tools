...
public class TransactionInput extends Message implements Serializable {
    ...
    /*
     * Deserializes an input message. This is usually part of a transaction
     * message.
     */
    ...
    /*
     * Convenience method that returns the from address of this input by parsing
     * the scriptSig.
     *
     * @throws ScriptException if the scriptSig could not be understood (eg, if
