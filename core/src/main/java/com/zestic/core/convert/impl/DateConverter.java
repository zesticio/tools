...
public class DateConverter extends AbstractConverter<java.util.Date> {
    ...
    @Override protected java.util.Date convertInternal(Object value) {
        ...
        throw new ConvertException("Can not convert {}:[{}] to {}", value.getClass().getName(),
            value, this.targetType.getName());
    }
    ...
    private java.util.Date wrap(DateTime date) {
        ...
        throw new UnsupportedOperationException(
            StrUtil.format("Unsupported target Date type: {}", this.targetType.getName()));
    }
    ...
    @SuppressWarnings("unchecked") @Override public Class<java.util.Date> getTargetType() {
