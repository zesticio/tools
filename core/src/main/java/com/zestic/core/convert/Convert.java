...
import com.zestic.core.convert.impl.CollectionConverter;
import com.zestic.core.convert.impl.EnumConverter;
import com.zestic.core.convert.impl.MapConverter;
import com.zestic.core.lang.Assert;
import com.zestic.core.lang.TypeReference;
import com.zestic.core.text.UnicodeUtil;
...
public class Convert {
     ...
     * @return Enum
     */
    @SuppressWarnings("unchecked") public static <E extends Enum<E>> E toEnum(Class<E> clazz,
        Object value, E defaultValue) {
     ...
     * @since 3.0.8
     */
    public static Collection<?> toCollection(Class<?> collectionType, Class<?> elementType,
        Object value) {
     ...
     * @since 4.1.20
     */
    @SuppressWarnings("unchecked") public static <T> List<T> toList(Class<T> elementType,
        Object value) {
     ...
     * @since 5.7.3
     */
    @SuppressWarnings("unchecked") public static <T> Set<T> toSet(Class<T> elementType,
        Object value) {
     ...
     * @since 4.6.8
     */
    @SuppressWarnings("unchecked") public static <K, V> Map<K, V> toMap(Class<K> keyType,
        Class<V> valueType, Object value) {
