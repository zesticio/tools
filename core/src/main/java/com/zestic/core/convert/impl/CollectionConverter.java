...
import com.zestic.core.convert.Converter;
...
public class CollectionConverter implements Converter<Collection<?>> {
    ...
    @Override public Collection<?> convert(Object value, Collection<?> defaultValue)
    ...
    protected Collection<?> convertInternal(Object value) {
        final Collection<Object> collection =
            CollUtil.create(TypeUtil.getClass(this.collectionType));
