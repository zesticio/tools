...
public abstract class AbstractConverter<T> implements Converter<T>, Serializable {
    ...
    @Override @SuppressWarnings("unchecked") public T convert(Object value, T defaultValue) {
        ...
        if (null == defaultValue || targetType.isInstance(defaultValue)) {
            ...
            throw new IllegalArgumentException(
                StrUtil.format("Default value [{}]({}) is not the instance of [{}]", defaultValue,
                    defaultValue.getClass(), targetType));
        }
    }
     ...
     */
    @SuppressWarnings("unchecked") public Class<T> getTargetType() {
