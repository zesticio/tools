...
import com.zestic.core.annotation.AnnotationUtil;
import com.zestic.core.annotation.PropIgnore;
import com.zestic.core.convert.Convert;
import com.zestic.core.util.ClassUtil;
import com.zestic.core.util.ModifierUtil;
...
public class PropDesc {
    ...
    private boolean isTransientForGet() {
        boolean isTransient =
            ModifierUtil.hasModifier(this.field, ModifierUtil.ModifierType.TRANSIENT);

        // 检查Getter方法
        if (false == isTransient && null != this.getter) {
            isTransient =
                ModifierUtil.hasModifier(this.getter, ModifierUtil.ModifierType.TRANSIENT);
    ...
    private boolean isTransientForSet() {
        ...
        if (false == isTransient && null != this.setter) {
            isTransient =
                ModifierUtil.hasModifier(this.setter, ModifierUtil.ModifierType.TRANSIENT);
