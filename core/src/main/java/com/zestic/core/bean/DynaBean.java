...
public class DynaBean extends CloneSupport<DynaBean> implements Serializable {
     ...
     */
    @SuppressWarnings("unchecked") public <T> T get(String fieldName) throws BeanException {
     ...
     * @throws BeanException 反射获取属性值或字段值导致的异常
     */
    @SuppressWarnings({"unchecked", "rawtypes"}) public void set(String fieldName, Object value)
     ...
     * @return bean
     */
    @SuppressWarnings("unchecked") public <T> T getBean() {
        return (T) this.bean;
    }
     ...
     * @return Bean类型
     */
    @SuppressWarnings("unchecked") public <T> Class<T> getBeanClass() {
