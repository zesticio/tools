...
import com.zestic.core.collection.EnumerationIter;
...
import com.zestic.core.util.JNDIUtil;
...
public class NetUtil {
    ...
    public static int getUsableLocalPort(int minPort, int maxPort) {
        ...
        throw new UtilException(
            "Could not find an available port in the range [{}, {}] after {} attempts", minPort,
    ...
    public static TreeSet<Integer> getUsableLocalPorts(int numRequested, int minPort, int maxPort) {
        ...
        if (availablePorts.size() != numRequested) {
            throw new UtilException("Could not find {} available  ports in the range [{}, {}]",
                numRequested, minPort, maxPort);
        }
    ...
    public static boolean isInnerIP(String ipAddress) {
        ...
        isInnerIp =
            isInner(ipNum, aBegin, aEnd) || isInner(ipNum, bBegin, bEnd) || isInner(ipNum, cBegin,
                cEnd) || LOCAL_IP.equals(ipAddress);
        return isInnerIp;
    }
    ...
    public static String toAbsoluteUrl(String absoluteBasePath, String relativePath) {
        try {
            ...
            throw new UtilException(e, "To absolute url [{}] base [{}] error!", relativePath,
                absoluteBasePath);
        }
    }
    ...
    public static String hideIpPart(String ip) {
        return StrUtil.builder(ip.length()).append(ip, 0, ip.lastIndexOf(".") + 1).append("*")
            .toString();
    }
    ...
    public static LinkedHashSet<InetAddress> localAddressList(Filter<InetAddress> addressFilter) {
        ...
        while (networkInterfaces.hasMoreElements()) {
            ...
            while (inetAddresses.hasMoreElements()) {
                ...
                if (inetAddress != null && (null == addressFilter || addressFilter.accept(
                    inetAddress))) {
    ...
    public static boolean isInRange(String ip, String cidr) {
        ...
        int cidrIpAddr =
            (Integer.parseInt(cidrIps[0]) << 24) | (Integer.parseInt(cidrIps[1]) << 16) | (
