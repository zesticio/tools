...
public class ComparatorChain<E>
    ...
    @Override public Iterator<Comparator<E>> iterator() {
        return this.chain.iterator();
    }

    @Override public ComparatorChain<E> addChain(Comparator<E> element) {
     ...
     */
    @Override public int compare(final E o1, final E o2) throws UnsupportedOperationException {
        if (lock == false) {
            checkChainIntegrity();
            lock = true;
        }
    ...
    @Override public boolean equals(final Object object) {
        ...
        if (object.getClass().equals(this.getClass())) {
            ...
            //
            return Objects.equals(this.orderingBits, otherChain.orderingBits) && this.chain.equals(
                otherChain.chain);
        }
        return false;
    }
