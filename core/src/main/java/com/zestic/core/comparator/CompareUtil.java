...
public class CompareUtil {
     ...
     * @since 4.6.9
     */
    @SuppressWarnings({"rawtypes", "unchecked"}) public static <T> int compare(T c1, T c2,
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"}) public static <T> int compare(T o1, T o2,
    ...
    public static <T> Comparator<T> comparingPinyin(Function<T, String> keyExtractor,
        ...
        if (reverse) {
            return (o1, o2) -> pinyinComparator.compare(keyExtractor.apply(o2),
