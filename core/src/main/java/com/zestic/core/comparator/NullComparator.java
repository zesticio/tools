...
public class NullComparator<T> implements Comparator<T>, Serializable {
     ...
     */
    @SuppressWarnings("unchecked") public NullComparator(boolean nullGreater,
    ...
    @Override public Comparator<T> thenComparing(Comparator<? super T> other) {
        Objects.requireNonNull(other);
        return new NullComparator<>(nullGreater,
            comparator == null ? other : comparator.thenComparing(other));
    }

    @Override public Comparator<T> reversed() {
        return new NullComparator<>((false == nullGreater),
            comparator == null ? null : comparator.reversed());
    }
     ...
     */
    @SuppressWarnings({"rawtypes", "unchecked"}) protected int doCompare(T a, T b) {
        if (null == comparator) {
