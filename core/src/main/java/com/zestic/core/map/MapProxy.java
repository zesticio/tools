...
import com.zestic.core.getter.OptNullBasicTypeFromObjectGetter;
import com.zestic.core.util.ArrayUtil;
import com.zestic.core.util.BooleanUtil;
import com.zestic.core.util.ClassLoaderUtil;
...
public class MapProxy
    implements Map<Object, Object>, OptNullBasicTypeFromObjectGetter<Object>, InvocationHandler,
    Serializable {
    ...
    @Override public Object getObj(Object key, Object defaultValue) {
    ...
    @SuppressWarnings("unchecked") @Override public Object put(Object key, Object value) {
    ...
    @SuppressWarnings({"unchecked", "NullableProblems"}) @Override public void putAll(Map<?, ?> m) {
        map.putAll(m);
    }
    ...
    @SuppressWarnings({"unchecked", "NullableProblems"}) @Override public Set<Object> keySet() {
        return map.keySet();
    }

    @SuppressWarnings({"unchecked", "NullableProblems"}) @Override
     ...
     * @since 4.5.2
     */
    @SuppressWarnings("unchecked") public <T> T toProxyBean(Class<T> interfaceClass) {
