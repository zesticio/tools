...
import com.zestic.core.io.resource.FileObjectResource;
import com.zestic.core.lang.ResourceClassLoader;
...
class JavaClassFileManager extends ForwardingJavaFileManager<JavaFileManager> {
     ...
     * @return Java字节码文件对象
     */
    @Override public JavaFileObject getJavaFileForOutput(final Location location,
