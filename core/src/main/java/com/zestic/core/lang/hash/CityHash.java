...
public class CityHash {
    ...
    public static long hash64(byte[] data) {
        ...
        do {
            ...
            w = weakHashLen32WithSeeds(data, pos + 32, z + w.getHighValue(),
                y + fetch64(data, pos + 16));
            // swap z,x value
            long swapValue = x;
            x = z;
            z = swapValue;
    ...
    private static Number128 hash128(final byte[] byteArray, int start, final Number128 seed) {
        ...
        do {
            ...
            w = weakHashLen32WithSeeds(byteArray, pos + 32, z + w.getHighValue(),
        ...
        for (int tail_done = 0; tail_done < len; ) {
            ...
            v = weakHashLen32WithSeeds(byteArray, pos + len - tail_done, v.getLowValue() + z,
                v.getHighValue());
            v.setLowValue(v.getLowValue() * k0);
        }
    ...
    private static int hash32Len13to24(byte[] byteArray) {
        ...
        @SuppressWarnings("UnnecessaryLocalVariable") int h = len;
    ...
    private static Number128 weakHashLen32WithSeeds(long w, long x, long y, long z, long a,
        long b) {
        a += w;
        b = rotate(b + a + z, 21);
        long c = a;
