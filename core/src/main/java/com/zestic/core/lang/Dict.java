...
public class Dict extends LinkedHashMap<String, Object> implements BasicTypeGetter<String> {
     ...
     * @since 5.4.1
     */
    @SafeVarargs public static Dict of(Pair<String, Object>... pairs) {
    ...
    @Override public Object getObj(String key) {
     ...
     * @return 字段值
     */
    @SuppressWarnings("unchecked") public <T> T get(String attr, T defaultValue) {
     ...
     * @return 字段值
     */
    @Override public String getStr(String attr) {
     ...
     * @return 字段值
     */
    @Override public Integer getInt(String attr) {
     ...
     * @return 字段值
     */
    @Override public Long getLong(String attr) {
     ...
     * @return 字段值
     */
    @Override public Float getFloat(String attr) {
        return Convert.toFloat(get(attr), null);
    }

    @Override public Short getShort(String attr) {
        return Convert.toShort(get(attr), null);
    }

    @Override public Character getChar(String attr) {
        return Convert.toChar(get(attr), null);
    }

    @Override public Double getDouble(String attr) {
        return Convert.toDouble(get(attr), null);
    }

    @Override public Byte getByte(String attr) {
     ...
     * @return 字段值
     */
    @Override public Boolean getBool(String attr) {
     ...
     * @return 字段值
     */
    @Override public BigDecimal getBigDecimal(String attr) {
     ...
     * @return 字段值
     */
    @Override public BigInteger getBigInteger(String attr) {
        return Convert.toBigInteger(get(attr));
    }

    @Override public <E extends Enum<E>> E getEnum(Class<E> clazz, String key) {
     ...
     * @return 字段值
     */
    @Override public Date getDate(String attr) {
        return get(attr, null);
    }
     ...
     * @since 5.7.14
     */
    @SuppressWarnings("unchecked") public <T> T getByPath(String expression) {
