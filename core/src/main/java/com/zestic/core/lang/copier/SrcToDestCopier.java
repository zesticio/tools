...
public abstract class SrcToDestCopier<T, C extends SrcToDestCopier<T, C>>
     ...
     * @return this
     */
    @SuppressWarnings("unchecked") public C setSrc(T src) {
        this.src = src;
        return (C) this;
    }
     ...
     * @return this
     */
    @SuppressWarnings("unchecked") public C setDest(T dest) {
        this.dest = dest;
        return (C) this;
    }
     ...
     * @return this
     */
    @SuppressWarnings("unchecked") public C setCopyFilter(Filter<T> copyFilter) {
