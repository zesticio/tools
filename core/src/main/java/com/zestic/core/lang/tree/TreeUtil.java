...
import com.zestic.core.lang.tree.parser.DefaultNodeParser;
import com.zestic.core.lang.tree.parser.NodeParser;
...
public class TreeUtil {
    ...
    public static <E> Tree<E> buildSingle(List<TreeNode<E>> list, E parentId) {
        return buildSingle(list, parentId, TreeNodeConfig.DEFAULT_CONFIG,
     ...
     * @since 5.7.2
     */
    public static <T, E> Tree<E> buildSingle(List<T> list, E parentId,
     ...
     * @return List
     */
    public static <T, E> List<Tree<E>> build(List<T> list, E parentId,
        NodeParser<T, E> nodeParser) {
