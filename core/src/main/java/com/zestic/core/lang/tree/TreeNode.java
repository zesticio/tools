...
public class TreeNode<T> implements Node<T> {
    ...
    @Override public TreeNode<T> setId(T id) {
        this.id = id;
        return this;
    }

    @Override public T getParentId() {
        return this.parentId;
    }

    @Override public TreeNode<T> setParentId(T parentId) {
        this.parentId = parentId;
        return this;
    }
    ...
    @Override public TreeNode<T> setName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    @Override public TreeNode<T> setWeight(Comparable<?> weight) {
        this.weight = weight;
        return this;
    }
