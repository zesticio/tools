package com.zestic.core.lang.caller;
...
public class SecurityManagerCaller extends SecurityManager implements Caller, Serializable {
    ...
    @Override public Class<?> getCaller() {
    ...
    @Override public Class<?> getCallerCaller() {
        final Class<?>[] context = getClassContext();
    ...
    @Override public Class<?> getCaller(int depth) {
        final Class<?>[] context = getClassContext();
    ...
    @Override public boolean isCalledBy(Class<?> clazz) {
