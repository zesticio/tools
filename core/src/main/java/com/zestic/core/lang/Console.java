...
public class Console {
    ...
    public static void log(Object obj1, Object... otherObjs) {
        if (ArrayUtil.isEmpty(otherObjs)) {
            ...
            log(buildTemplateSplitBySpace(otherObjs.length + 1),
                ArrayUtil.insert(otherObjs, 0, obj1));
        }
    }
    ...
    public static void log(String template, Object... values) {
        if (ArrayUtil.isEmpty(values) || StrUtil.contains(template, TEMPLATE_VAR)) {
            ...
            logInternal(buildTemplateSplitBySpace(values.length + 1),
                ArrayUtil.insert(values, 0, template));
        }
    }
    ...
    public static void print(Object obj1, Object... otherObjs) {
        if (ArrayUtil.isEmpty(otherObjs)) {
            ...
            print(buildTemplateSplitBySpace(otherObjs.length + 1),
                ArrayUtil.insert(otherObjs, 0, obj1));
        }
    }
    ...
    public static void print(String template, Object... values) {
        if (ArrayUtil.isEmpty(values) || StrUtil.contains(template, TEMPLATE_VAR)) {
            ...
            printInternal(buildTemplateSplitBySpace(values.length + 1),
                ArrayUtil.insert(values, 0, template));
        }
    }
    ...
    public static void error(Object obj1, Object... otherObjs) {
        if (ArrayUtil.isEmpty(otherObjs)) {
            ...
            error(buildTemplateSplitBySpace(otherObjs.length + 1),
                ArrayUtil.insert(otherObjs, 0, obj1));
        }
    }
    ...
    public static void error(String template, Object... values) {
        if (ArrayUtil.isEmpty(values) || StrUtil.contains(template, TEMPLATE_VAR)) {
            ...
            errorInternal(buildTemplateSplitBySpace(values.length + 1),
                ArrayUtil.insert(values, 0, template));
        }
    }
