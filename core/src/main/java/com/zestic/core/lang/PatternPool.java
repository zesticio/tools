...
public class PatternPool {
     ...
     * Http URL
     */
    public final static Pattern URL_HTTP =
        Pattern.compile(RegexPool.URL_HTTP, Pattern.CASE_INSENSITIVE);
    /*
     * 中文字、英文字母、数字和下划线
     */
    public final static Pattern GENERAL_WITH_CHINESE =
        Pattern.compile(RegexPool.GENERAL_WITH_CHINESE);
    /*
     * UUID
     */
    ...
    public static final Pattern MAC_ADDRESS =
        Pattern.compile(RegexPool.MAC_ADDRESS, Pattern.CASE_INSENSITIVE);
    /*
     * 16进制字符串
     */
    ...
    public static final Pattern CAR_DRIVING_LICENCE =
        Pattern.compile(RegexPool.CAR_DRIVING_LICENCE);
