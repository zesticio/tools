...
import com.zestic.core.date.SystemClock;
...
public class Snowflake implements Serializable {
    ...
    // 最大支持机器节点数0~31，一共32个
    @SuppressWarnings({"PointlessBitwiseExpression", "FieldCanBeLocal"}) private static final long
    ...
    @SuppressWarnings("FieldCanBeLocal") private static final long SEQUENCE_MASK =
    ...
    public synchronized long nextId() {
        ...
        return ((timestamp - twepoch) << TIMESTAMP_LEFT_SHIFT) | (dataCenterId
