package com.zestic.core.text.split;

import com.zestic.core.collection.ComputeIter;
import com.zestic.core.lang.Assert;
import com.zestic.core.text.finder.TextFinder;
...
public class SplitIter extends ComputeIter<String> implements Serializable {
     ...
     */
    public SplitIter(CharSequence text, TextFinder separatorFinder, int limit,
        boolean ignoreEmpty) {
