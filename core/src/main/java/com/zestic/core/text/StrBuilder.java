...
public class StrBuilder implements CharSequence, Appendable, Serializable {
     ...
     * @return this
     */
    @Override public StrBuilder append(char c) {
    ...
    @Override public StrBuilder append(CharSequence csq) {
        return insert(this.position, csq);
    }

    // ------------------------------------------------------------------------------------ Insert

    @Override public StrBuilder append(CharSequence csq, int start, int end) {
