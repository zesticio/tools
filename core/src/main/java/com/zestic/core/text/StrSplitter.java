...
import com.zestic.core.text.finder.*;
import com.zestic.core.text.split.SplitIter;
...
public class StrSplitter {
     ...
     * @since 3.2.1
     */
    public static List<String> splitIgnoreCase(CharSequence str, char separator, int limit,
     ...
     * @since 5.7.14
     */
    public static <R> List<R> split(CharSequence text, char separator, int limit,
        boolean ignoreEmpty, boolean ignoreCase, Function<String, R> mapping) {
     ...
     * @since 3.2.1
     */
    public static List<String> split(String text, String separator, int limit, boolean isTrim,
        boolean ignoreEmpty, boolean ignoreCase) {
        final SplitIter splitIter =
    ...
    public static List<String> split(String text, int limit) {
        ...
        final SplitIter splitIter =
            new SplitIter(text, new CharMatcherFinder(CharUtil::isBlankChar), limit, true);
     ...
     * @since 3.0.8
     */
    public static List<String> splitByRegex(String str, String separatorRegex, int limit,
        boolean isTrim, boolean ignoreEmpty) {
     ...
     * @since 3.0.8
     */
    public static List<String> split(String text, Pattern separatorPattern, int limit,
        boolean isTrim, boolean ignoreEmpty) {
        if (StrUtil.isEmpty(text)) {
            return new ArrayList<>(0);
        }
