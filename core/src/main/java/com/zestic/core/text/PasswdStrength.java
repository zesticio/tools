...
public class PasswdStrength {
    ...
    public static int check(String passwd) {
        ...
        if (len > 4 && countLetter(passwd, CHAR_TYPE.NUM) > 0
        ...
        if (len > 6 && countLetter(passwd, CHAR_TYPE.NUM) > 0
            && countLetter(passwd, CHAR_TYPE.SMALL_LETTER) > 0
            && countLetter(passwd, CHAR_TYPE.CAPITAL_LETTER) > 0
            || countLetter(passwd, CHAR_TYPE.NUM) > 0
            && countLetter(passwd, CHAR_TYPE.SMALL_LETTER) > 0
        ...
        if (len > 8 && countLetter(passwd, CHAR_TYPE.NUM) > 0
            && countLetter(passwd, CHAR_TYPE.SMALL_LETTER) > 0
            && countLetter(passwd, CHAR_TYPE.CAPITAL_LETTER) > 0
            && countLetter(passwd, CHAR_TYPE.OTHER_CHAR) > 0) {
            level++;
        ...
        if (len > 6 && countLetter(passwd, CHAR_TYPE.NUM) >= 3
        ...
        if (len > 8 && countLetter(passwd, CHAR_TYPE.NUM) >= 2
        ...
        if (len > 10 && countLetter(passwd, CHAR_TYPE.NUM) >= 2
            && countLetter(passwd, CHAR_TYPE.SMALL_LETTER) >= 2
            && countLetter(passwd, CHAR_TYPE.CAPITAL_LETTER) >= 2
            && countLetter(passwd, CHAR_TYPE.OTHER_CHAR) >= 2) {
            level++;
        ...
        if (StrUtil.isNumeric(passwd) && ("01234567890".indexOf(passwd) > 0
