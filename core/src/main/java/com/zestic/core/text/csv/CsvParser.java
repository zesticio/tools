package com.zestic.core.text.csv;

import com.zestic.core.collection.ComputeIter;
...
public final class CsvParser extends ComputeIter<CsvRow> implements Closeable, Serializable {
    ...
    @Override protected CsvRow computeNext() {
        return nextRow();
    }
            ...
            if (config.errorOnDifferentFieldCount) {
                if (firstLineFieldCount < 0) {
                    ...
                    throw new IORuntimeException(
                        String.format("Line %d has %d fields, but first line has %d fields", lineNo,
