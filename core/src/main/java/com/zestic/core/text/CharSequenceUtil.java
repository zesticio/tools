package com.zestic.core.text;

import com.zestic.core.collection.CollUtil;
import com.zestic.core.comparator.VersionComparator;
...
public class CharSequenceUtil {
     ...
     * @since 3.1.2
     */
    public static String stripIgnoreCase(CharSequence str, CharSequence prefix,
        CharSequence suffix) {
        if (isEmpty(str)) {
            return str(str);
        }
     ...
     * @since 5.7.14
     */
    public static <R> List<R> split(CharSequence str, char separator, int limit,
        boolean ignoreEmpty, Function<String, R> mapping) {
        if (null == str) {
     ...
     * @since 5.6.7
     */
    public static List<String> split(CharSequence str, CharSequence separator, boolean isTrim,
        boolean ignoreEmpty) {
        return split(str, separator, 0, isTrim, ignoreEmpty);
    }
    ...
    public static String[] cut(CharSequence str, int partLength) {
        ...
        for (int i = 0; i < part; i++) {
            array[i] = str2.substring(i * partLength,
                (i == part - 1) ? len : (partLength + i * partLength));
        }
        return array;
    }
    ...
    public static String subByCodePoint(CharSequence str, int fromIndex, int toIndex) {
        ...
        str.toString().codePoints().skip(fromIndex).limit(subLen)
     ...
     * @since 5.2.5
     */
    public static String[] subBetweenAll(CharSequence str, CharSequence prefix,
        CharSequence suffix) {
     ...
     * @since 5.4.1
     */
    public static String[] wrapAllWithPairIfMissing(CharSequence prefixAndSuffix,
        CharSequence... strs) {
     ...
     * @since 4.0.7
     */
    public static String[] wrapAllIfMissing(CharSequence prefix, CharSequence suffix,
        CharSequence... strs) {
        final String[] results = new String[strs.length];
        for (int i = 0; i < strs.length; i++) {
     ...
     * @since 3.0.7
     */
    public static String appendIfMissing(CharSequence str, CharSequence suffix,
     ...
     * @since 3.0.7
     */
    public static String appendIfMissingIgnoreCase(CharSequence str, CharSequence suffix,
        CharSequence... suffixes) {
     ...
     * @since 3.0.7
     */
    public static String prependIfMissing(CharSequence str, CharSequence prefix,
     ...
     * @since 3.0.7
     */
    public static String prependIfMissingIgnoreCase(CharSequence str, CharSequence prefix,
        CharSequence... prefixes) {
     ...
     * @since 4.0.3
     */
    public static String replace(CharSequence str, int fromIndex, CharSequence searchStr,
        CharSequence replacement, boolean ignoreCase) {
     ...
     * @since 3.2.1
     */
    public static String replace(CharSequence str, int startInclude, int endExclude,
        char replacedChar) {
        if (isEmpty(str)) {
            return str(str);
        }
     ...
     * @since 4.2.2
     */
    public static String replace(CharSequence str, String regex,
        Func1<java.util.regex.Matcher, String> replaceFun) {
     ...
     * @since 5.6.2
     */
    public static String desensitized(CharSequence str,
    ...
    public static String brief(CharSequence str, int maxLength) {
        ...
        final String str2 = str.toString();
        return format("{}...{}", str2.substring(0, maxLength - w),
     ...
     * @since 5.4.1
     */
    @SuppressWarnings("unchecked") public <T extends CharSequence> T firstNonNull(T... strs) {
     ...
     * @since 5.4.1
     */
    @SuppressWarnings("unchecked") public <T extends CharSequence> T firstNonEmpty(T... strs) {
     ...
     * @since 5.4.1
     */
    @SuppressWarnings("unchecked") public <T extends CharSequence> T firstNonBlank(T... strs) {
