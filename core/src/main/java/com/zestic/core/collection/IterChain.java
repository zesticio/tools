 ...
 *
 * @param <T> 元素类型
 * @author <a href="https://www.zestic.io">Deebendu Kumar</a>, jodd
 */
public class IterChain<T> implements Iterator<T>, Chain<Iterator<T>, IterChain<T>> {
     ...
     */
    @SafeVarargs public IterChain(Iterator<T>... iterators) {
    ...
    @Override public IterChain<T> addChain(Iterator<T> iterator) {
    ...
    @Override public Iterator<Iterator<T>> iterator() {
