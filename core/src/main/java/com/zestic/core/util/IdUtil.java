...
import com.zestic.core.lang.Snowflake;
import com.zestic.core.lang.UUID;
import com.zestic.core.lang.id.NanoId;
...
public class IdUtil {
    ...
    public static long getDataCenterId(long maxDatacenterId) {
        ...
        if (null != mac) {
            id = ((0x000000FF & (long) mac[mac.length - 2]) | (0x0000FF00 & (
                ((long) mac[mac.length - 1]) << 8))) >> 6;
