...
import com.zestic.core.map.BiMap;
...
public class XmlUtil {
     ...
     * @since 3.2.0
     */
    @SuppressWarnings("unchecked") public static <T> T readObjectFromXml(InputSource source) {
        Object result;
    ...
    public static Document createXml(String rootElementName, String namespace) {
        ...
        doc.appendChild(null == namespace ?
    ...
    public static List<Element> getElements(Element element, String tagName) {
        final NodeList nodeList = StrUtil.isBlank(tagName) ?
     ...
     * @since 4.0.8
     */
    @SuppressWarnings("unchecked") public static Map<String, Object> xmlToMap(Node node,
    ...
    public static String mapToXmlStr(Map<?, ?> data, String rootName, String namespace,
        boolean omitXmlDeclaration) {
        return toStr(mapToXml(data, rootName, namespace), CharsetUtil.UTF_8, false,
            omitXmlDeclaration);
    }
     ...
     */
    public static String mapToXmlStr(Map<?, ?> data, String rootName, String namespace,
        String charset, boolean isPretty, boolean omitXmlDeclaration) {
    ...
    public static Element appendChild(Node node, String tagName, String namespace) {
        ...
        final Element child = (null == namespace) ?
     ...
     * @param data 数据
     */
    @SuppressWarnings("rawtypes") private static void append(Document doc, Node node, Object data) {
     ...
     * @since 4.0.8
     */
    @SuppressWarnings({"rawtypes", "unchecked"}) private static void appendMap(Document doc,
        Node node, Map data) {
     ...
     * @param data 数据
     */
    @SuppressWarnings("rawtypes") private static void appendIterator(Document doc, Node node,
        Iterator data) {
