...
import com.zestic.core.compress.Deflate;
import com.zestic.core.compress.Gzip;
import com.zestic.core.compress.ZipReader;
import com.zestic.core.compress.ZipWriter;
 ...
 * @see com.zestic.core.compress.ZipWriter
 */
public class ZipUtil {
     ...
     * @since 4.6.5
     */
    public static File zip(File zipFile, Charset charset, boolean withSrcDir, FileFilter filter,
        File... srcFiles) throws IORuntimeException {
     ...
     */
    public static void zip(OutputStream out, Charset charset, boolean withSrcDir, FileFilter filter,
        File... srcFiles) throws IORuntimeException {
     ...
     */
    @Deprecated public static void zip(ZipOutputStream zipOutputStream, boolean withSrcDir,
        FileFilter filter, File... srcFiles) throws IORuntimeException {
     ...
     * @since 5.5.2
     */
    public static File zip(File zipFile, Charset charset, Resource... resources)
        throws UtilException {
    ...
    private static void validateFiles(File zipFile, File... srcFiles) throws UtilException {
        if (zipFile.isDirectory()) {
            throw new UtilException("Zip file [{}] must not be a directory !",
        ...
        for (File srcFile : srcFiles) {
            ...
            if (false == srcFile.exists()) {
                throw new UtilException(
                    StrUtil.format("File [{}] not exist!", srcFile.getAbsolutePath()));
            }
