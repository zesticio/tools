...
import com.zestic.core.net.URLDecoder;
import com.zestic.core.net.URLEncodeUtil;
import com.zestic.core.net.url.UrlQuery;
...
public class URLUtil extends URLEncodeUtil {
     ...
     * @since 5.3.6
     */
    public static String getDataUri(String mimeType, Charset charset, String encoding,
        String data) {
