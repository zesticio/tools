...
import com.zestic.core.lang.Holder;
import com.zestic.core.lang.PatternPool;
import com.zestic.core.lang.RegexPool;
import com.zestic.core.lang.Validator;
...
public class ReUtil {
     ...
     * @return 新字符串
     */
    public static String extractMultiAndDelPre(Pattern pattern, Holder<CharSequence> contentHolder,
        String template) {
     ...
     * @return 按照template拼接后的字符串
     */
    public static String extractMultiAndDelPre(String regex, Holder<CharSequence> contentHolder,
        String template) {
    ...
    public static String delLast(Pattern pattern, CharSequence str) {
        if (null != pattern && StrUtil.isNotEmpty(str)) {
            ...
            if (null != matchResult) {
                return StrUtil.subPre(str, matchResult.start()) + StrUtil.subSuf(str,
                    matchResult.end());
            }
        }
     ...
     * @return 结果集
     */
    public static <T extends Collection<String>> T findAll(String regex, CharSequence content,
        int group, T collection) {
        if (null == regex) {
            return collection;
        }
     ...
     * @return 结果集
     */
    public static <T extends Collection<String>> T findAll(Pattern pattern, CharSequence content,
        int group, T collection) {
     ...
     * @return 处理后的文本
     */
    public static String replaceAll(CharSequence content, String regex,
    ...
    public static String replaceAll(CharSequence content, Pattern pattern,
        ...
        if (result) {
            final Set<String> varNums =
                findAll(PatternPool.GROUP_VAR, replacementTemplate, 1, new HashSet<>());
     ...
     * @since 4.2.2
     */
    public static String replaceAll(CharSequence str, String regex,
     ...
     * @since 4.2.2
     */
    public static String replaceAll(CharSequence str, Pattern pattern,
        Func1<Matcher, String> replaceFun) {
