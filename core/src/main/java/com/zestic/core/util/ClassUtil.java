...
import com.zestic.core.bean.NullWrapperBean;
import com.zestic.core.convert.BasicType;
...
import com.zestic.core.lang.ClassScanner;
import com.zestic.core.lang.Filter;
import com.zestic.core.lang.Singleton;
...
public class ClassUtil {
     ...
     */
    @SuppressWarnings("unchecked") public static <T> Class<T> getClass(T obj) {
    ...
    /*
     * 获取完整类名的短格式如：<br>
     * com.zestic.core.util.StrUtil -》c.h.c.u.StrUtil
     *
     * @param className 类名
     * @return 短格式类名
     * @since 4.1.9
    ...
    public static boolean equals(Class<?> clazz, String className, boolean ignoreCase) {
        ...
        if (ignoreCase) {
            return className.equalsIgnoreCase(clazz.getName()) || className.equalsIgnoreCase(
                clazz.getSimpleName());
        } else {
     ...
     * @return 类
     */
    @SuppressWarnings("unchecked") public static <T> Class<T> loadClass(String className,
     ...
     * @return 返回结果
     */
    public static <T> T invoke(String classNameWithMethodName, boolean isSingleton,
        Object... args) {
        ...
        if (splitIndex <= 0) {
            throw new UtilException("Invalid classNameWithMethodName [{}]!",
     ...
     * @return 返回结果
     */
    public static <T> T invoke(String className, String methodName, boolean isSingleton,
        Object... args) {
        ...
        try {
            ...
            if (isStatic(method)) {
                ...
                return ReflectUtil.invoke(isSingleton ? Singleton.get(clazz) : clazz.newInstance(),
                    method, args);
            }
        } catch (Exception e) {
    ...
    public static boolean isSimpleTypeOrArray(Class<?> clazz) {
        ...
        return isSimpleValueType(clazz) || (clazz.isArray() && isSimpleValueType(
