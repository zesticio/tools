...
import com.zestic.core.lang.ParameterizedTypeImpl;
import com.zestic.core.lang.reflect.ActualTypeMapperPool;
...
public class TypeUtil {
    ...
    public static Type getActualType(Type type, Field field) {
        ...
        return getActualType(ObjectUtil.defaultIfNull(type, field.getDeclaringClass()),
    ...
    public static Type getActualType(Type type, ParameterizedType parameterizedType) {
        ...
        if (TypeUtil.hasTypeVariable(actualTypeArguments)) {
            ...
            if (ArrayUtil.isNotEmpty(actualTypeArguments)) {
                ...
                parameterizedType =
                    new ParameterizedTypeImpl(actualTypeArguments, parameterizedType.getOwnerType(),
