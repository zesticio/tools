...
public class ChannelCopier extends IoCopier<ReadableByteChannel, WritableByteChannel> {
    ...
    @Override public long copy(ReadableByteChannel source, WritableByteChannel target) {
     ...
     */
    private long doCopy(ReadableByteChannel source, WritableByteChannel target, ByteBuffer buffer,
        StreamProgress progress) throws IOException {
