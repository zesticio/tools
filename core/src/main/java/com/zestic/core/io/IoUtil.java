...
import com.zestic.core.collection.LineIter;
import com.zestic.core.convert.Convert;
import com.zestic.core.exceptions.UtilException;
import com.zestic.core.io.copy.ReaderWriterCopier;
import com.zestic.core.io.copy.StreamCopier;
...
public class IoUtil extends NioUtil {
     ...
     * @throws IORuntimeException IO异常
     */
    public static long copy(Reader reader, Writer writer, int bufferSize, long count,
        StreamProgress streamProgress) throws IORuntimeException {
     ...
     * @since 5.7.8
     */
    public static long copy(InputStream in, OutputStream out, int bufferSize, long count,
        StreamProgress streamProgress) throws IORuntimeException {
     ...
     */
    @Deprecated public static BufferedReader getReader(InputStream in, String charsetName) {
     ...
     */
    @Deprecated public static OutputStreamWriter getWriter(OutputStream out, String charsetName) {
     ...
     */
    @Deprecated public static String read(InputStream in, String charsetName)
        throws IORuntimeException {
            ...
            try {
                ...
                if (readLength != available) {
                    throw new IOException(
                        StrUtil.format("File length is [{}] but read [{}]!", available,
                            readLength));
                }
            } catch (IOException e) {
                throw new IORuntimeException(e);
     ...
     */
    @Deprecated public static <T extends Collection<String>> T readLines(InputStream in,
     ...
     * @throws IORuntimeException IO异常
     */
    public static <T extends Collection<String>> T readLines(InputStream in, Charset charset,
     ...
     */
    @Deprecated public static ByteArrayInputStream toStream(String content, String charsetName) {
     ...
     */
    @Deprecated public static void write(OutputStream out, String charsetName, boolean isCloseOut,
        Object... contents) throws IORuntimeException {
    ...
    public static void writeObjects(OutputStream out, boolean isCloseOut, Serializable... contents)
        ...
        try {
            osw = out instanceof ObjectOutputStream ?
