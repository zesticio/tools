package com.zestic.core.io.watch;

import com.zestic.core.io.FileUtil;
import com.zestic.core.io.IORuntimeException;
import com.zestic.core.io.watch.watchers.WatcherChain;
...
public class WatchMonitor extends WatchServer {
     ...
     */
    @Override public void init() throws WatchException {
        //获取目录或文件路径
        if (false == Files.exists(this.path, LinkOption.NOFOLLOW_LINKS)) {
            ...
            if (null != lastPathEle) {
                ...
                if (StrUtil.contains(lastPathEleStr, StrUtil.C_DOT)
                    && false == StrUtil.endWithIgnoreCase(lastPathEleStr, ".d")) {
