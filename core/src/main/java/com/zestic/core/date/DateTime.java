...
import com.zestic.core.date.format.DatePrinter;
import com.zestic.core.date.format.FastDateFormat;
...
public class DateTime extends Date {
    ...
    public DateTime(Instant instant, ZoneId zoneId) {
        this(instant.toEpochMilli(),
            TimeZone.getTimeZone(ObjectUtil.defaultIfNull(zoneId, ZoneId.systemDefault())));
    }
    ...
    private static Date parse(CharSequence dateStr, DateFormat dateFormat) {
        ...
        try {
            ...
            throw new DateException(
                StrUtil.format("Parse [{}] with format [{}] error!", dateStr, pattern), e);
        }
    }
    ...
    public boolean isIn(Date beginDate, Date endDate) {
        ...
        return thisMills >= Math.min(beginMills, endMills) && thisMills <= Math.max(beginMills,
            endMills);
    }
    ...
    public String toString(TimeZone timeZone) {
        if (null != timeZone) {
            return toString(
                DateUtil.newSimpleFormat(DatePattern.NORM_DATETIME_PATTERN, null, timeZone));
        }
    ...
    public String toDateStr() {
        if (null != this.timeZone) {
            return toString(
                DateUtil.newSimpleFormat(DatePattern.NORM_DATE_PATTERN, null, timeZone));
        }
    ...
    public String toTimeStr() {
        if (null != this.timeZone) {
            return toString(
                DateUtil.newSimpleFormat(DatePattern.NORM_TIME_PATTERN, null, timeZone));
        }
