...
public class FastDateParser extends AbstractDateBasic implements DateParser {
    ...
    private static final Strategy ABBREVIATED_YEAR_STRATEGY = new NumberStrategy(Calendar.YEAR) {
        @Override int modify(final FastDateParser parser, final int iValue) {
     ...
     */
    private static Map<String, Integer> appendDisplayNames(final Calendar cal, final Locale locale,
        final int field, final StringBuilder regex) {
    ...
    private static abstract class Strategy {
        ...
        abstract boolean parse(FastDateParser parser, Calendar calendar, String source,
            ParsePosition pos, int maxWidth);
    }
    ...
    private static abstract class PatternStrategy extends Strategy {
        ...
        @Override boolean parse(final FastDateParser parser, final Calendar calendar,
    ...
    private static class CaseInsensitiveTextStrategy extends PatternStrategy {
         ...
         */
        CaseInsensitiveTextStrategy(final int field, final Calendar definingCalendar,
            final Locale locale) {
            this.field = field;
            this.locale = locale;
        ...
        @Override void setCalendar(final FastDateParser parser, final Calendar cal,
            final String value) {
    ...
    static class TimeZoneStrategy extends PatternStrategy {
        ...
        TimeZoneStrategy(final Locale locale) {
            ...
            sb.append(
                "((?iu)" + RFC_822_TIME_ZONE + "|" + UTC_TIME_ZONE_WITH_OFFSET + "|" + GMT_OPTION);
