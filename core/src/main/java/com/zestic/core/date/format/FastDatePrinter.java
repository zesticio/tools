package com.zestic.core.date.format;

import com.zestic.core.date.DateException;
...
public class FastDatePrinter extends AbstractDateBasic implements DatePrinter {
    ...
    @Override public String format(long millis) {
    ...
    @Override public String format(Calendar calendar) {
        return format(calendar, new StringBuilder(mMaxLengthEstimate)).toString();
    }

    @Override public <B extends Appendable> B format(long millis, B buf) {
        final Calendar c = Calendar.getInstance(timeZone, locale);
        c.setTimeInMillis(millis);
    ...
    @Override public <B extends Appendable> B format(Date date, B buf) {
        final Calendar c = Calendar.getInstance(timeZone, locale);
        c.setTime(date);
        return applyRules(c, buf);
    }

    @Override public <B extends Appendable> B format(Calendar calendar, B buf) {
    ...
    private static class CharacterLiteral implements Rule {
        ...
        @Override public void appendTo(final Appendable buffer, final Calendar calendar)
            throws IOException {
    ...
    private static class StringLiteral implements Rule {
         ...
         * {@inheritDoc}
         */
        @Override public void appendTo(Appendable buffer, Calendar calendar) throws IOException {
            buffer.append(mValue);
        }
    }
    ...
    private static class UnpaddedNumberField implements NumberRule {
         ...
         * {@inheritDoc}
         */
        @Override public final void appendTo(Appendable buffer, int value) throws IOException {
            if (value < 10) {
                buffer.append((char) (value + '0'));
            } else if (value < 100) {
    ...
    private static class TwelveHourField implements NumberRule {
         ...
         * {@inheritDoc}
         */
        @Override public void appendTo(Appendable buffer, int value) throws IOException {
            mRule.appendTo(buffer, value);
        }
    }
