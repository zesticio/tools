package com.zestic.core.date;

import com.zestic.core.comparator.CompareUtil;
import com.zestic.core.convert.NumberChineseFormatter;
import com.zestic.core.date.format.DateParser;
import com.zestic.core.date.format.FastDateParser;
import com.zestic.core.date.format.GlobalCustomFormat;
...
public class CalendarUtil {
    ...
    public static Calendar truncate(Calendar calendar, DateField dateField) {
        return DateModifier.modify(calendar, dateField.getValue(),
            DateModifier.ModifyType.TRUNCATE);
    }
     ...
     * @since 4.1.0
     */
    @SuppressWarnings({"MagicConstant", "ConstantConditions"}) public static Calendar endOfQuarter(
        Calendar calendar) {
    ...
    public static String yearAndQuarter(Calendar cal) {
        return StrUtil.builder().append(cal.get(Calendar.YEAR))
    ...
    protected static int age(long birthday, long dateToCompare) {
        ...
        if (month == monthBirth) {
            ...
            if ((false == isLastDayOfMonth || false == isLastDayOfMonthBirth)
     ...
     * @since 5.3.11
     */
    public static Calendar parseByPatterns(String str, Locale locale, boolean lenient,
        String... parsePatterns) throws DateException {
