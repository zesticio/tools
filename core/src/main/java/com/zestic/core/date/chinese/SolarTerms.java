package com.zestic.core.date.chinese;

import com.zestic.core.date.ChineseDate;
 ...
 * 24节气相关信息
 *
 * @author <a href="https://www.zestic.io">Deebendu Kumar</a>, zak
 * @since 5.4.1
 */
public class SolarTerms {
    ...
    private static final String[] S_TERM_INFO =
        new String[] {"9778397bd097c36b0b6fc9274c91aa", "97b6b97bd19801ec9210c965cc920e",
    ...
    private static String getTermInternal(int year, int mouth, int day) {
        ...
        final int termInfo =
            Integer.parseInt(termTable.substring(segment * 5, (segment + 1) * 5), 16);
