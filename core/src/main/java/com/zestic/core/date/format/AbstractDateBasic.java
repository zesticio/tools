...
public abstract class AbstractDateBasic implements DateBasic, Serializable {
     ...
     */
    protected AbstractDateBasic(final String pattern, final TimeZone timeZone,
        final Locale locale) {
    ...
    @Override public boolean equals(final Object obj) {
        ...
        return pattern.equals(other.pattern) && timeZone.equals(other.timeZone) && locale.equals(
            other.locale);
    }
