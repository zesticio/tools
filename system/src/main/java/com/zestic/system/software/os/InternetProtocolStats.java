...
@ThreadSafe public interface InternetProtocolStats {
     ...
     */
    @Immutable final class TcpStats {
        ...
        public TcpStats(long connectionsEstablished, long connectionsActive,
            long connectionsPassive, long connectionFailures, long connectionsReset,
        ...
        @Override public String toString() {
            return "TcpStats [connectionsEstablished=" + connectionsEstablished
                + ", connectionsActive=" + connectionsActive + ", connectionsPassive="
                + connectionsPassive + ", connectionFailures=" + connectionFailures
                + ", connectionsReset=" + connectionsReset + ", segmentsSent=" + segmentsSent
                + ", segmentsReceived=" + segmentsReceived + ", segmentsRetransmitted="
                + segmentsRetransmitted + ", inErrors=" + inErrors + ", outResets=" + outResets
                + "]";
        }
    }
     ...
     */
    @Immutable final class UdpStats {
        ...
        @Override public String toString() {
            return "UdpStats [datagramsSent=" + datagramsSent + ", datagramsReceived="
                + datagramsReceived + ", datagramsNoPort=" + datagramsNoPort
                + ", datagramsReceivedErrors=" + datagramsReceivedErrors + "]";
        }
    }
     ...
     */
    @Immutable final class IPConnection {
        ...
        public IPConnection(String type, byte[] localAddress, int localPort, byte[] foreignAddress,
            int foreignPort, TcpState state, int transmitQueue, int receiveQueue,
            int owningProcessId) {
            this.type = type;
        ...
        @Override public String toString() {
            ...
            return "IPConnection [type=" + type + ", localAddress=" + localIp + ", localPort="
                + localPort + ", foreignAddress=" + foreignIp + ", foreignPort=" + foreignPort
                + ", state=" + state + ", transmitQueue=" + transmitQueue + ", receiveQueue="
                + receiveQueue + ", owningProcessId=" + owningProcessId + "]";
        }
    }
}
