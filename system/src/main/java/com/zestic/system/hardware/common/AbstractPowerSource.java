...
import com.zestic.system.hardware.platform.linux.LinuxPowerSource;
import com.zestic.system.hardware.platform.mac.MacPowerSource;
import com.zestic.system.hardware.platform.unix.aix.AixPowerSource;
import com.zestic.system.hardware.platform.unix.freebsd.FreeBsdPowerSource;
import com.zestic.system.hardware.platform.unix.solaris.SolarisPowerSource;
import com.zestic.system.hardware.platform.windows.WindowsPowerSource;
 ...
 * A Power Source
 */
@ThreadSafe public abstract class AbstractPowerSource implements PowerSource {
    ...
    @Override public double getRemainingCapacityPercent() {
        return this.remainingCapacityPercent;
    }

    @Override public double getTimeRemainingEstimated() {
        return this.timeRemainingEstimated;
    }

    @Override public double getTimeRemainingInstant() {
        return this.timeRemainingInstant;
    }

    @Override public double getPowerUsageRate() {
    ...
    @Override public double getAmperage() {
        return this.amperage;
    }

    @Override public boolean isPowerOnLine() {
    ...
    @Override public boolean isDischarging() {
        return this.discharging;
    }

    @Override public CapacityUnits getCapacityUnits() {
    ...
    @Override public int getDesignCapacity() {
    ...
    @Override public String getChemistry() {
        return this.chemistry;
    }

    @Override public LocalDate getManufactureDate() {
    ...
    @Override public String toString() {
        ...
        sb.append("RemainingCapacityPercent: ").append(getRemainingCapacityPercent() * 100)
            .append("%, ");
        sb.append("Time Remaining: ").append(formatTimeRemaining(getTimeRemainingEstimated()))
            .append(", ");
        ...
        sb.append("Manufacture Date: ")
            .append(getManufactureDate() != null ? getManufactureDate() : Constants.UNKNOWN)
            .append(", ");
