...
@ThreadSafe public interface CentralProcessor {
     ...
     */
    @Immutable class LogicalProcessor {
         ...
         */
        public LogicalProcessor(int processorNumber, int physicalProcessorNumber,
         ...
         */
        public LogicalProcessor(int processorNumber, int physicalProcessorNumber,
            int physicalPackageNumber, int numaNode) {
         ...
         */
        public LogicalProcessor(int processorNumber, int physicalProcessorNumber,
            int physicalPackageNumber, int numaNode, int processorGroup) {
        ...
        @Override public String toString() {
            return "LogicalProcessor [processorNumber=" + processorNumber + ", coreNumber="
                + physicalProcessorNumber + ", packageNumber=" + physicalPackageNumber
                + ", numaNode=" + numaNode + ", processorGroup=" + processorGroup + "]";
        }
    }
     ...
     */
    @Immutable final class ProcessorIdentifier {
        private static final String OSHI_ARCHITECTURE_PROPERTIES =
            "com.zestic.system.architecture.properties";
        ...
        private final Supplier<String> microArchictecture =
            Memoizer.memoize(this::queryMicroarchitecture);

        public ProcessorIdentifier(String cpuVendor, String cpuName, String cpuFamily,
            String cpuModel, String cpuStepping, String processorID, boolean cpu64bit) {
        ...
        private String queryMicroarchitecture() {
            String arch = null;
            Properties archProps =
                FileUtil.readPropertiesFromFilename(OSHI_ARCHITECTURE_PROPERTIES);
