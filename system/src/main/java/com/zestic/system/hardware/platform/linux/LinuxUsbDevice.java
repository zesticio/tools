...
@Immutable public class LinuxUsbDevice extends AbstractUsbDevice {
    ...
    public LinuxUsbDevice(String name, String vendor, String vendorId, String productId,
                    ...
                    if (device != null) {
                        try {
                            ...
                            if (DEVTYPE_USB_DEVICE.equals(device.getDevtype())) {
                                ...
                                UdevDevice parent =
                                    device.getParentWithSubsystemDevtype(SUBSYSTEM_USB,
                                        DEVTYPE_USB_DEVICE);
                                if (parent == null) {
                                    ...
                                    hubMap.computeIfAbsent(parentPath, x -> new ArrayList<>())
                                        .add(syspath);
                                }
                            }
                        } finally {
