 ...
 */
@ThreadSafe public final class Iostat {
     ...
     */
    public static Map<String, Quintet<String, String, String, String, Long>> queryDeviceStrings(
        Set<String> diskSet) {
        ...
        for (String line : iostat) {
            ...
            for (String keyValue : split) {
                ...
                if (diskSet.contains(keyValue)) {
                    ...
                    // update
                    if (diskName != null) {
                        deviceParamMap.put(diskName,
                            new Quintet<>(model, vendor, product, serial, size));
                    }
