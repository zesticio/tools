...
package com.zestic.system.jna.platform.unix.freebsd;
...
public interface FreeBsdLibc extends CLibrary {
     ...
     * Connection info
     */
    @FieldOrder({"ut_type", "ut_tv", "ut_id", "ut_pid", "ut_user", "ut_line", "ut_host",
        "ut_spare"}) class FreeBsdUtmpx extends Structure {
     ...
     * CPU Ticks
     */
    @FieldOrder({"cpu_ticks"}) class CpTime extends Structure {
