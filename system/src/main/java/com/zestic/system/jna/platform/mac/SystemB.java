...
public interface SystemB extends com.sun.jna.platform.mac.SystemB, CLibrary {
     ...
     */
    @FieldOrder({"proc_fd", "proc_fdtype"}) class ProcFdInfo extends Structure {
        public int proc_fd;
     ...
     */
    @FieldOrder({"insi_fport", "insi_lport", "insi_gencnt", "insi_flags", "insi_flow", "insi_vflag",
        "insi_ip_ttl", "rfu_1", "insi_faddr", "insi_laddr", "insi_v4", "insi_v6"}) class InSockInfo
        extends Structure {
     ...
     * Mac TCP socket info
     */
    @FieldOrder({"tcpsi_ini", "tcpsi_state", "tcpsi_timer", "tcpsi_mss", "tcpsi_flags", "rfu_1",
        "tcpsi_tp"}) class TcpSockInfo extends Structure {
     ...
     * Mack IP Socket Info
     */
    @FieldOrder({"soi_stat", "soi_so", "soi_pcb", "soi_type", "soi_protocol", "soi_family",
        "soi_options", "soi_linger", "soi_state", "soi_qlen", "soi_incqlen", "soi_qlimit",
        "soi_timeo", "soi_error", "soi_oobmark", "soi_rcv", "soi_snd", "soi_kind", "rfu_1",
        "soi_proto"}) class SocketInfo extends Structure {
     ...
     * Mac socket info
     */
    @FieldOrder({"pfi", "psi"}) class SocketFdInfo extends Structure {
