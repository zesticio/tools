...
public class CpuInfo {
     ...
     */
    public CpuInfo(Integer cpuNum, double toTal, double sys, double used, double wait, double free,
        String cpuModel) {
        this.cpuNum = cpuNum;
        this.toTal = toTal;
        this.sys = sys;
    ...
    @Override public String toString() {
        return "CpuInfo{" + "cpu核心数=" + cpuNum + ", CPU总的使用率=" + toTal + ", CPU系统使用率=" + sys
            + ", CPU用户使用率=" + used + ", CPU当前等待率=" + wait + ", CPU当前空闲率=" + free + ", CPU利用率="
            + LOAD_FORMAT.format(100 - free) + ", CPU型号信息='" + cpuModel + '\'' + '}';
    }
