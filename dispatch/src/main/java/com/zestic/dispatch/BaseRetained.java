...
public class BaseRetained implements Retained {
    ...
    private static final int MAX_TRACES = Integer.getInteger("com.zestic.dispatch.BaseRetained.MAX_TRACES", 100);
    private static final boolean TRACE = Boolean.getBoolean("com.zestic.dispatch.BaseRetained.TRACE");
