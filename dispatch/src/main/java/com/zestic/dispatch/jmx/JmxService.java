...
import com.zestic.dispatch.Dispatcher;
import com.zestic.dispatch.Metrics;
import com.zestic.dispatch.internal.HawtDispatcher;
...
public class JmxService {
    ...
    static public interface JmxDispatcherMBean {
        @com.zestic.dispatch.jmx.MBeanInfo("Used to enable or disable profiling")
        public void setTimeUnit(String unit);

        @com.zestic.dispatch.jmx.MBeanInfo("Is profiling enabled.")
